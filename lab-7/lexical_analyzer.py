...
class LexicalAnalyzer:
    def __init__(self, source_code: [], identifiers_fsm: FiniteStateMachine,
                 constants_fsm: FiniteStateMachine) -> None:
        self.atoms = {}
        ...
        self._regex_patterns = {
            ...
            ">>": ">>", "<<": "<<", ">": ">", "<": "<", "!": "!", "(": "\\(",
            ")": "\\)", "{": "{", "}": "}", ";": ";", ",": ","}
        self._identifiers_fsm = identifiers_fsm
        self._constants_fsm = constants_fsm
